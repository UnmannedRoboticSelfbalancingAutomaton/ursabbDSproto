int ctrlModeVal=0;//0=stop, 1=screen joystick, 2=accelerometer
...
void draw() {
  ...
  ss.display(false);
  String[] modes={"joystick", "tilt"};//0=stop hardcoded in
  boolean[] ok={true, accelerometerAvail};
